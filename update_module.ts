...
let m1_regex = /\{\/\*\s*SECTION:\s*LIVE MAP.*?\*\/\s*<div className="space-y-[46]">\s*<div className="flex items-center justify-between px-2">([\s\S]*?)<Card className="bg-slate-900 border-white\/5([^>]*)>/;
